...
| Phase | Scope | Suite |
|---|---|---|
| **3** | log verification (checkpoint, D45), proposals, approval and the review (D52), windows over the declared categories (D50), atomic commit + recovery, `inject interrupt`, `inject corrupt --kind commit-unauthorized`, the deterministic probes and the commit's validation against them (D56), `inject probe` | OC-001(a)(b), OC-002(d) 2.6 2.7, OC-004, 10.3 |
